...
<!-- Mirrored from themesdesign.in/oxhen/layouts/index-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 22 Feb 2022 12:10:28 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Oxhen</title>
        ...
        <!-- fevicon -->
        <link rel="shortcut icon" href="project2\themesdesign.in\oxhen\layouts/images/favicon.ico">

        <!-- Bootstrap css -->
        <link rel="stylesheet" href="project2\themesdesign.in\oxhen\layouts/css/bootstrap.min.css" type="text/css" />

        <!-- animation -->
        <link rel="stylesheet" href="project2\themesdesign.in\oxhen\layouts/css/aos.css" />

        <!-- slider -->
        <link rel="stylesheet" href="project2\themesdesign.in\oxhen\layouts/css/swiper-bundle.min.css" />

        <!-- Icon -->
        <link rel="stylesheet" href="project2\themesdesign.in\oxhen\layouts/css/materialdesignicons.min.css" type="text/css" />

        <!-- css -->
        <link rel="stylesheet" href="project2\themesdesign.in\oxhen\layouts/css/style.min.css" type="text/css" />
    </head>
    <body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-offset="71">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body p-5">
                            <div class="text-center mb-5">
                                ...
                                <p class="fs-14">Already Have an account? <a href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)">Log in here</a></p>
                            </div>
                            <div class="d-grid gap-3">
                                <a class="btn btn-outline-dark btn-lg" href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)">
                                <span class="d-flex justify-content-center align-items-center">
                                    <img class="avatar avatar-xs me-2" src="project2\themesdesign.in\oxhen\layouts/images/google.jpg" alt="Image Description">
                                    Sign up with Google
                                </span>
                                </a>
                                <a class="btn btn-primary btn-lg" href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)">Sign up with Email</a>
                                <div class="text-center">
                                    <p class="mb-0 fs-13">By continuing you agree to our <a class="text-primary" href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)">Terms and Conditions</a></p>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer d-block text-center px-5 pb-5">
                            ...
                            <div class="mx-auto">
                              <div class="row justify-content-between">
                                <div class="col">project2\themesdesign.in\oxhen\layouts/
                                  <img class="img-fluid" src="project2\themesdesign.in\oxhen\layouts/images/github.svg" alt="Logo">
                                </div>
                                <div class="col">
                                    <img class="img-fluid" src="project2\themesdesign.in\oxhen\layouts/images/gitlab.svg" alt="Logo">
                                </div>
                                <div class="col">
                                    <img class="img-fluid" src="project2\themesdesign.in\oxhen\layouts/images/linkedin.svg" alt="Logo">
                                </div>
                                <div class="col">
                                    <img class="img-fluid" src="project2\themesdesign.in\oxhen\layouts/images/instagram.svg" alt="Logo">
                                </div>
                              </div>
                            </div>
                            <!-- End Row -->
                    ...
                    <div class="col-lg-7">
                        <div class="home-heading">
                            <h1 class="mb-3 text-white">Start your Successful
                                Business With <span class="typewrite text-primary d-none d-sm-inline-block" data-period="2000" data-type='[ "Oxhen" ]'>
                        ...
                        <div class="home-btn hstack gap-2 flex-column d-sm-block">
                            <a class="btn btn-white me-1" href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)">Request Free Demo</a>
                            <a class="modal-btn" href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)" data-bs-toggle="modal" data-bs-target=".watchvideomodal">
                            ...
                            <div class="feature-card p-3 py-sm-4 rounded d-flex">
                                ...
                                <div class="flex-grow-1 ms-2">
                                        <div class="content">
                                            ...
                                            <a href="project2\themesdesign.in\oxhen\layouts/javascipt:void(0)" class="text-dark">Read More <i class="mdi mdi-chevron-right"></i></a>
                                        </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div data-aos="fade-right" data-aos-duration="1800">
                            <div class="card bg-transparent border-0 mb-3 mb-lg-0">
                                <img src="project2\themesdesign.in\oxhen\layouts/images/feature1.png" class="img-fluid rounded-3" alt="">
                            </div>
                        </div>
                    </div><!-- end col -->
                    <div class="col-lg-5">
                        <div data-aos="fade-left" data-aos-duration="1800">
                            ...
                            <a class="btn btn-primary" href="project2\themesdesign.in\oxhen\layouts/javascipt:void(0)">Learn more</a>
                        </div>
                    </div><!-- end col -->
                </div><!-- end row -->
                            ...
                            <div class="accordion" id="accordionExample">
                                ...
                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        ...
                                        <a href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)" class="fs-14 text-decoration-none">
                                            Check it out <i class="mdi mdi-arrow-right"></i>
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-6">
                        <div data-aos="fade-left" data-aos-duration="1800">
                            <div class="card bg-transparent border-0">
                                <img src="project2\themesdesign.in\oxhen\layouts/images/feature2.png" class="img-fluid" alt="">
                            </div>
                        </div>
                    </div><!-- end col -->
                </div><!-- end row-->
                ...
                <div class="row justify-content-center text-center">
                    <div class="col-lg-6">
                        <div data-aos="fade-down" data-aos-duration="1800">
                            ...
                            <a class="btn btn-primary" href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)">Learn More</a>
                        </div>
                    </div><!-- end col-->
                </div><!-- end row-->
            </div><!-- end container-->
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="card reviews-card">
                                                        <div class="card-body text-center">
                                                            <img class="img-fluid" src="project2\themesdesign.in\oxhen\layouts/images/user/user1.png" alt="">
                                                            <div class="mt-3">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="d-flex align-items-top">
                                                        <div class="flex-shrink-0">
                                                            <img class="reviews-quote-1" src="project2\themesdesign.in\oxhen\layouts/images/quote.png" alt="">
                                                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="card reviews-card">
                                                        <div class="card-body text-center">
                                                            <img class="img-fluid" src="project2\themesdesign.in\oxhen\layouts/images/user/user2.png" alt="">
                                                            <div class="mt-3">
                                                                <h6 class="mb-0">Brandon Carney</h6>
                                                                <p class="text-muted mb-0 fs-14">Vice president</p>
                                                            </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="card reviews-card">
                                                        <div class="card-body text-center">
                                                            <img class="img-fluid" src="project2\themesdesign.in\oxhen\layouts/images/user/user.png" alt="">
                                                            <div class="mt-3">
                                                                <h6 class="mb-0">Brandon Carney</h6>
                                                                <p class="text-muted mb-0 fs-14">Vice president</p>
                                                            </div>
                        ...
                        <div data-aos="fade-right" data-aos-duration="1800">
                            <div class="card pricing-box mx-1 mt-4">
                                ...
                                <div class="p-4">
                                    ...
                                    <div class="d-grid">
                                        <a href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)" class="btn btn-outline-primary">Choose Plan</a>
                                    </div>
                                </div>
                            </div><!-- End card -->
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card pricing-box mx-1 mt-4 active">
                            ...
                            <div class="p-4">
                                ...
                                <div class="d-grid">
                                    <a href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)" class="btn btn-outline-primary active">Choose Plan</a>
                                </div>
                            </div>
                        </div><!-- End card -->
                    </div><!-- col end -->
            ...
            <div class="container">
                ...
                <div class="row gy-4">
                    <div class="col-lg-3 col-sm-6">
                        <div class="team-card">
                            <div class="team-card-img">
                               <img class="img-fluid" src="project2\themesdesign.in\oxhen\layouts/images/user/user.png" alt="image">
                                <div class="team-social-icons">
                                    <ul class="list-inline">
                                        <li class="list-inline-item">
                                            <a href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)" target="">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="team-card">
                            <div class="team-card-img">
                               <img class="img-fluid" src="project2\themesdesign.in\oxhen\layouts/images/user/user1.png" alt="image">
                                <div class="team-social-icons">
                                    <ul class="list-inline">
                                        <li class="list-inline-item">
                                            <a href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)" target="">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="team-card">
                            <div class="team-card-img">
                               <img class="img-fluid" src="project2\themesdesign.in\oxhen\layouts/images/user/user2.png" alt="image">
                                <div class="team-social-icons">
                                    <ul class="list-inline">
                                        <li class="list-inline-item">
                                            <a href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)" target="">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="team-card">
                            <div class="team-card-img">
                               <img class="img-fluid" src="project2\themesdesign.in\oxhen\layouts/images/user/user3.png" alt="image">
                                <div class="team-social-icons">
                                    <ul class="list-inline">
                                        <li class="list-inline-item">
                                            <a href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)" target="">
        ...
        <section class="section contact" id="contact">
            <div class="container">
                ...
                <div class="row align-items-center gy-3">
                    ...
                    <div class="col-lg-6">
                        <div data-aos="fade-left" data-aos-duration="1800">
                            <form method="post" class="contact-form" name="myForm" onsubmit="return validateForm()">
                                <p id="error-msg"></p>
        ...
        <footer class="section footer">
            <div class="container">project2\themesdesign.in\oxhen\layouts/
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-sm-10 text-center">
                        <a href="javascript:void(0)"><img src="project2\themesdesign.in\oxhen\layouts/images/logo-light.png" height="24" alt=""></a>
                        ...
                        <ul class="list-unstyled mb-0 mt-4 social-icon">
                            <li class="list-inline-item"><a href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)"><i class="mdi mdi-facebook"></i></a></li>
                            <li class="list-inline-item"><a href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)"><i class="mdi mdi-twitter"></i></a></li>
                            <li class="list-inline-item"><a href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)"><i class="mdi mdi-instagram"></i></a></li>
                            <li class="list-inline-item"><a href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)"><i class="mdi mdi-vimeo"></i></a></li>
                            <li class="list-inline-item"><a href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)"><i class="mdi mdi-google-plus"></i></a></li>
                            <li class="list-inline-item"><a href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)"><i class="mdi mdi-linkedin"></i></a></li>
                        </ul>
                    </div><!--end col-->
                </div><!--end row-->
                <div class="row justify-content-center">
                        ...
                        <div class="text-center mt-3">
                            <ul class="list-unstyled mb-0">
                                <li class="list-inline-item mx-lg-3 m-2">
                                    <a class="text-white" href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)">Home</a>
                                </li>
                                <li class="list-inline-item mx-lg-3 m-2">
                                    <a class="text-white" href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)">About us</a>
                                </li>
                                <li class="list-inline-item mx-lg-3 m-2">
                                    <a class="text-white" href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)">Order</a>
                                </li>
                                <li class="list-inline-item mx-lg-3 m-2">
                                    <a class="text-white" href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)">Member</a>
                                </li>
                                <li class="list-inline-item mx-lg-3 m-2">
                                    <a class="text-white" href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)">Contact Us</a>
                                </li>
                            </ul>
                        </div>
                    </div><!-- end col-->
        ...
        <!--Custom js-->
        <script src="project2\themesdesign.in\oxhen\layouts/js/counter.js"></script>

        <!--Bootstrap Js-->
        <script src="project2\themesdesign.in\oxhen\layouts/js/bootstrap.bundle.min.js"></script>

        <!-- animation -->
        <script src="project2\themesdesign.in\oxhen\layouts/js/aos.js"></script>

        <!-- swiper js -->
        <script src="project2\themesdesign.in\oxhen\layouts/js/swiper-bundle.min.js"></script>

        <!-- contact -->
        <script src="project2\themesdesign.in\oxhen\layouts/js/contact.js"></script>

        <!-- Team particles-->
        <script src="project2\themesdesign.in\oxhen\layouts/js/particles.min.js"></script>

        <!-- App Js -->
        <script src="project2\themesdesign.in\oxhen\layouts/js/app.js"></script>

    </body>

<!-- Mirrored from themesdesign.in/oxhen/layouts/index-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 22 Feb 2022 12:10:34 GMT -->
</html>