...
<head>
    ...
    <!-- Icon -->
    <link rel="stylesheet" href="project2\themesdesign.in\oxhen\layouts/css/materialdesignicons.min.css"
        type="text/css" />
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-white navbar-custom sticky" id="navbar" role="navigation">
        <div class="container">
            ...
            <a class="navbar-brand text-uppercase" href="index-1.html">
                <img class="logo-light" src="project2\themesdesign.in\oxhen\layouts/images/logo-light.png" alt=""
                    height="25">
                <img class="logo-dark" src="project2\themesdesign.in\oxhen\layouts/images/logo-dark.png" alt=""
                    height="25">
            </a>

            <button id="navbar-example" class="navbar-toggler" type="button" data-bs-toggle="collapse"
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <button type="button" class="btn btn-primary nav-btn" data-bs-toggle="modal"
                ...
                <div class="modal-body p-5">
                    <div class="text-center mb-5">
                        ...
                        <p class="fs-14">Already Have an account? <a
                                href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)">Log in here</a></p>
                    </div>
                    <div class="d-grid gap-3">
                        <a class="btn btn-outline-dark btn-lg"
                            href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)">
                            <span class="d-flex justify-content-center align-items-center">
                                <img class="avatar avatar-xs me-2"
                                    src="project2\themesdesign.in\oxhen\layouts/images/google.jpg"
                                    alt="Image Description">
                                Sign up with Google
                            </span>
                        </a>
                        <a class="btn btn-primary btn-lg"
                            href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)">Sign up with Email</a>
                        <div class="text-center">
                            <p class="mb-0 fs-13">By continuing you agree to our <a class="text-primary"
                                    href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)">Terms and
                                    Conditions</a></p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="mx-auto">
                        <div class="row justify-content-between">
                            <div class="col">project2\themesdesign.in\oxhen\layouts/
                                <img class="img-fluid" src="project2\themesdesign.in\oxhen\layouts/images/github.svg"
                                    alt="Logo">
                            </div>
                            <div class="col">
                                <img class="img-fluid" src="project2\themesdesign.in\oxhen\layouts/images/gitlab.svg"
                                    alt="Logo">
                            </div>
                            <div class="col">
                                <img class="img-fluid" src="project2\themesdesign.in\oxhen\layouts/images/linkedin.svg"
                                    alt="Logo">
                            </div>
                            <div class="col">
                                <img class="img-fluid" src="project2\themesdesign.in\oxhen\layouts/images/instagram.svg"
                                    alt="Logo">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7">
                        <div class="home-heading">
                            <h1 class="mb-3 text-white">Start your Successful
                                Business With <span class="typewrite text-primary d-none d-sm-inline-block"
                                    data-period="2000" data-type='[ "Oxhen" ]'>
                                    <span class="wrap"></span> </span>
                            </h1>
                        </div>
                        <p class="text-white-50 fs-20">Explore and learn more about everything from machine learning and
                            ...
                            <div class="feature-card p-3 py-sm-4 rounded d-flex">
                                ...
                                <div class="flex-grow-1 ms-2">
                                    <div class="content">
                                        ...
                                        <a href="project2\themesdesign.in\oxhen\layouts/javascipt:void(0)"
                                            class="text-dark">Read More <i class="mdi mdi-chevron-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-5">
                        <div data-aos="fade-left" data-aos-duration="1800">
                            ...
                            <ul class="feature-list">
                                ...
                                <li><i class="mdi mdi-checkbox-marked-circle-outline text-primary"></i>Update website
                                    content</li>
                            </ul>
                            <a class="btn btn-primary"
                                href="project2\themesdesign.in\oxhen\layouts/javascipt:void(0)">Learn more</a>
                        </div>
                    </div><!-- end col -->
                </div><!-- end row -->
                <div class="row align-items-center justify-content-between">
                    <div class="col-lg-6">
                        <div data-aos="fade-right" data-aos-duration="1800">
                            ...
                            <p class="text-muted">Lorem text is also used to demonstrate the appearance of different
                            ...
                            <div class="accordion" id="accordionExample">
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body">
                                            <p class="fs-14 text-muted mb-1">Lorem text is also used to demonstrate the
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingTwo">
                                        <a class="accordion-button collapsed" data-bs-toggle="collapse"
                                            ...
                                            <div>
                                                ...
                                                <p class="mb-0 fs-13 text-muted">Keep your engine going with free food
                                                    and drinks.</p>
                                            </div>
                                        </a>
                                    </h2>
                                    <div id="collapseTwo" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <p class="fs-14 text-muted mb-0">Lorem text is also used to demonstrate the
                                                appearance of different typefaces and layouts, and in general the
                                                content of dummy text is nonsensical.</p>
                                            <a href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)"
                                    ...
                                    <h2 class="accordion-header" id="headingThree">
                                        <a class="accordion-button collapsed" data-bs-toggle="collapse"
                                            ...
                                            <div>
                                                ...
                                                <p class="mb-0 fs-13 text-muted">Connectivity, power, and IT issues
                                                    solved in no time.</p>
                                            </div>
                                        </a>
                                    </h2>
                    ...
                    <div class="col-lg-6">
                        <div data-aos="fade-left" data-aos-duration="1800">
                            <div class="card bg-transparent border-0">
                                <img src="project2\themesdesign.in\oxhen\layouts/images/feature2.png" class="img-fluid"
                                    alt="">
                            </div>
                        </div>
                    </div><!-- end col -->
                ...
                <div class="row justify-content-center text-center">
                    <div class="col-lg-6">
                        <div data-aos="fade-down" data-aos-duration="1800">
                            ...
                            <a class="btn btn-primary"
                                href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)">Learn More</a>
                        </div>
                    </div><!-- end col-->
                </div><!-- end row-->
            </div><!-- end container-->
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="text-center mb-5">
                            ...
                            <p class="text-muted fs-17">Vivamus ac nulla ultrices laoreet neque mollis mi morbi
                                                ...
                                                <div class="col-md-4">
                                                    <div class="card reviews-card">
                                                        <div class="card-body text-center">
                                                            <img class="img-fluid"
                                                                src="project2\themesdesign.in\oxhen\layouts/images/user/user1.png"
                                                                alt="">
                                                            <div class="mt-3">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="card reviews-card">
                                                        <div class="card-body text-center">
                                                            <img class="img-fluid"
                                                                src="project2\themesdesign.in\oxhen\layouts/images/user/user2.png"
                                                                alt="">
                                                            <div class="mt-3">
                                                                <h6 class="mb-0">Brandon Carney</h6>
                                                                <p class="text-muted mb-0 fs-14">Vice president</p>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="card reviews-card">
                                                        <div class="card-body text-center">
                                                            <img class="img-fluid"
                                                                src="project2\themesdesign.in\oxhen\layouts/images/user/user.png"
                                                                alt="">
                                                            <div class="mt-3">
                                                                <h6 class="mb-0">Brandon Carney</h6>
                                                                <p class="text-muted mb-0 fs-14">Vice president</p>
                        ...
                        <div data-aos="fade-right" data-aos-duration="1800">
                            <div class="card pricing-box mx-1 mt-4">
                                <div class="card">
                                    <div class="card-body">
                                        <h6>Standard</h6>
                                        <h1 class="mb-0 pt-2 fw-bold">$10 <sub class="fs-14 fw-normal">/-Monthly</sub>
                                        </h1>
                                    </div>
                                </div>
                                <div class="p-4">
                                                ...
                                                <div class="flex-shring-0">
                                                    <div class="avatar-xs">
                                                        <div class="avatar-title rounded-circle bg-soft-primary">
                                                            <i
                                                                class="mdi mdi-checkbox-marked-circle-outline text-primary"></i>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                    ...
                                    <div class="d-grid">
                                        <a href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)"
                                            class="btn btn-outline-primary">Choose Plan</a>
                                    </div>
                                </div>
                            </div><!-- End card -->
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card pricing-box mx-1 mt-4 active">
                            ...
                            <div class="p-4">
                                ...
                                <div class="d-grid">
                                    <a href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)"
                                        class="btn btn-outline-primary active">Choose Plan</a>
                                </div>
                            </div>
                        </div><!-- End card -->
                    </div><!-- col end -->
                        ...
                        <div data-aos="fade-left" data-aos-duration="1800">
                            <div class="card pricing-box mx-1 mt-4">
                                <div class="card">
                                    <div class="card-body">
                                        <h6>Enterprise</h6>
                                        <h1 class="mb-0 pt-2 fw-bold">$39 <sub class="fs-14 fw-normal">/-Monthly</sub>
                                        </h1>
                                    </div>
                                </div>
                                <div class="p-4">
                ...
                <div class="row gy-4">
                    <div class="col-lg-3 col-sm-6">
                        <div class="team-card">
                            <div class="team-card-img">
                                <img class="img-fluid" src="project2\themesdesign.in\oxhen\layouts/images/user/user.png"
                                    alt="image">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="team-card">
                            <div class="team-card-img">
                                <img class="img-fluid"
                                    src="project2\themesdesign.in\oxhen\layouts/images/user/user1.png" alt="image">
                                <div class="team-social-icons">
                                    <ul class="list-inline">
                                        <li class="list-inline-item">
                                            <a href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)"
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="team-card">
                            <div class="team-card-img">
                                <img class="img-fluid"
                                    src="project2\themesdesign.in\oxhen\layouts/images/user/user3.png" alt="image">
                                <div class="team-social-icons">
                                    <ul class="list-inline">
                                        <li class="list-inline-item">
                                            <a href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)"
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="text-center mb-5">
                            ...
                            <p class="text-muted mt-2 fs-17">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                sed
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-sm-10 text-center">
                        <a href="javascript:void(0)"><img
                                src="project2\themesdesign.in\oxhen\layouts/images/logo-light.png" height="24"
                                alt=""></a>
                        <p class="mx-auto mt-sm-4">Obviously I'm a Web Designer. Experienced with all stages of the
                            development cycle for dynamic web projects.</p>
                        <ul class="list-unstyled mb-0 mt-4 social-icon">
                            <li class="list-inline-item"><a
                                    href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)"><i
                        ...
                        <div class="text-center mt-3">
                            <ul class="list-unstyled mb-0">
                                <li class="list-inline-item mx-lg-3 m-2">
                                    <a class="text-white"
                                        href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)">Home</a>
                                </li>
                                <li class="list-inline-item mx-lg-3 m-2">
                                    <a class="text-white"
                                        href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)">About us</a>
                                </li>
                                <li class="list-inline-item mx-lg-3 m-2">
                                    <a class="text-white"
                                        href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)">Order</a>
                                </li>
                                <li class="list-inline-item mx-lg-3 m-2">
                                    <a class="text-white"
                                        href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)">Member</a>
                                </li>
                                <li class="list-inline-item mx-lg-3 m-2">
                                    <a class="text-white"
                                        href="project2\themesdesign.in\oxhen\layouts/javascript:void(0)">Contact Us</a>
                                </li>
                            </ul>
                        </div>
                    </div><!-- end col-->
