        ...
        <div class="card shadow">
          <div class="signin-wrapper">
            <div class="form-wrapper">
              <form action="submit/opertor_login2.php" method="post" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-12">
                    ...
                    <div class="input-style-1">
                      ...
                      <input type="email" name="email" class="form-control" placeholder="Enter your registered email here" />
                      <?php
